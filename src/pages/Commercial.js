...
const Commercial = () => {
    ...
    const getResidentialcode = async (loc) => {
      const addResidential1 = collection(db, loc.length === 0 ? `commercial_code/service_and_feeder_load_calculations/codes` : `commercial_code/${loc}/codes`);
    ...
    const AddCommercial = async (props) => {
        ...
        setIsLoading(true);
      const addResidential2 = collection(db, location.length === 0 ? `commercial_code/service_and_feeder_load_calculations/codes` : `commercial_code/${addlocation}/codes`);
