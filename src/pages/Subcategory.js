...
const Subcategory = (props) => {
  ...
  const [location, setLocation] = useState("commercial_installs");
  ...
  const AddSubcategory = async (props) => {
    ...
    // });
    setIsLoading(true);
    const addSubcategories2 = collection(db, addlocation.length === 0 ? `categories/commercial_installs/subCategories` : `categories/${addlocation}/subCategories`);
            ...
            <div className="center-container">
              ...
              <AiFillCaretDown className="icon small" /> */}
                ...
                >
                  ...
                  <option value="commercial_installs" >All</option>
